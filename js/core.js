...
/* ═══════════════════════════════════════
   APP STATE
═══════════════════════════════════════ */
const DEF = { boardingRate:55, daycareRate:35, threshold:3, surchargePct:50, surchargeType:'percent', surchargeAmt:25, bizName:'Shvaan Pet Care', bizPhone:'', bizEmail:'', bizAddr:'', capacity:12, theme:'terracotta' };
